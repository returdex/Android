...
public class TrashNewsResponse {
    ...
    public void setList(String result) {
        try {
            ...
            for (int i=0; i < jsonArray.length(); ++i) {
                ...
                newslistBean.setId(jsonObject1.getString("id"));
                newslistBean.setCtime(jsonObject1.getString("ctime"));
                newslistBean.setTitle(jsonObject1.getString("title"));
                newslistBean.setDescription(jsonObject1.getString("description"));
                newslistBean.setSource(jsonObject1.getString("source"));
                newslistBean.setPicUrl(jsonObject1.getString("picUrl"));
                newslistBean.setUrl(jsonObject1.getString("url"));
    ...
    public List<String> getNewslistTitle() {
        List<String> list = new ArrayList<String>();
        for (int i=0; i<newslist.size(); ++i) {
            String name = newslist.get(i).getTitle();
            list.add(name);
        }
        return list;
    }
